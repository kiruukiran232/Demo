...
with col1:
  ...
  st.image("./IMG-20230405-WA0002.jpg", caption="Persian Cat", width=300,height=500,use_column_width=True)
  st.write("This pilla pichuka is very rare piece in the world")
with col2:
  st.subheader("Donkollu Pattevodu")
  st.image("./Screenshot_20221127-143419_Call.jpg", caption="Ragdoll Cat", width=300,height=500,use_column_width=True)
